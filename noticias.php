...
<div id="Wrapper">
  ...
  <!-- mfn_hook_content_before -->
  <div style="margin-top:200px;" class="section ">
      ...
      <div class="column one column_blog">
        <div class="blog_wrapper isotope_wrapper">
          <div class="posts_group lm_wrapper classic col-3">
            ...
            <div class="post-item isotope-item clearfix author-renata post-1336 post type-post status-publish format-standard has-post-thumbnail hentry category-artigos" style="">
              
              <div class="image_frame post-photo-wrapper scale-with-grid image">
                <div class="image_wrapper">
                <a href="vernoticias.php?id=<?php echo $row_conteudo2['id']; ?>">
                  <div class="mask"></div>
                  <img width="620" height="413" src="imagens/noticias/grande/<?php echo $row_conteudo2['nomeImg']; ?>" class="scale-with-grid wp-post-image">
                  </a>
                  <div class="image_links double"><a href="https://caiofrancasp.com.br/caiofranca/wp-content/uploads/2020/08/feminicidio.jpg" class="zoom" rel="lightbox" data-type="image"><i class="icon-search"></i></a><a href="https://caiofrancasp.com.br/2022/06/29/a-violencia-contra-a-mulher-no-centro-do-debate/" class="link"><i class="icon-link"></i></a></div>
                </div>
              </div>
              <div class="post-desc-wrapper bg-" style="">
                <div class="post-desc">
                  ...
                  <div class="post-title">
                    <h2 class="entry-title" itemprop="headline"><a href="vernoticias.php?id=<?php echo $row_conteudo2['id']; ?>"><?php echo $row_conteudo2['titulo']; ?></a></h2>
                  </div>
                  <div class="post-excerpt"><?php echo $row_conteudo2['subTitulo']; ?><span class="excerpt-hellip"> […]</span></div>
                  <div class="post-footer">
                    <div class="post-links"> <a href="vernoticias.php?id=<?php echo $row_conteudo2['id']; ?>" class="post-more">Leia mais</a></div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <!--<div class="column one pager_wrapper">
            <div class="pager">
              <div class="pages"><a href="https://caiofrancasp.com.br/category/artigos/" class="page active">1</a><a href="https://caiofrancasp.com.br/category/artigos/page/2/" class="page">2</a><a href="https://caiofrancasp.com.br/category/artigos/page/3/" class="page">3</a><span class="page">...</span><a href="https://caiofrancasp.com.br/category/artigos/page/10/" class="page">10</a></div>
              <a class="next_page" href="https://caiofrancasp.com.br/category/artigos/page/2/">Próxima página<i class="icon-right-open"></i></a></div>
          </div>-->
        </div>
      </div>
    </div>
